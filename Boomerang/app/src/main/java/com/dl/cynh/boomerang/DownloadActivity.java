...
public class DownloadActivity extends Activity {
    ...
    private com.dl.cynh.boomerang.Utils utils;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adView.setAdUnitId("ca-app-pub-9891261141906247/4286829618");
    ...
    private void startDl() {
        ...
        progress.show();
        new RequestTask()
                .execute("http://radiofrance-podcast.net/podcast09/rss_13937.xml");
    }
